...
import models.{ErrorResponse, IdentityDataException, UnexpectedDownstreamResponseError}
import models.alertOrRejection.SubmitAlertOrRejectionModel
import models.nrs.{AlertRejectNRSSubmission, IdentityData, NRSPayload}
...
class NRSBrokerService @Inject()(brokerConnector: NRSBrokerConnector,
  ...
  def submitPayload(submitAlertReject: SubmitAlertOrRejectionModel, ern: String)
    ...
    val submissionAsString = Json.stringify(Json.toJson(AlertRejectNRSSubmission(ern, submitAlertReject)))
