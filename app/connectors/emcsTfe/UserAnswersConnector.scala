...
class UserAnswersConnector @Inject()(val http: HttpClientV2,
  ...
  def get(ern: String, arc: String)
    ...
    http
      .get(url"$baseUrl/user-answers/alert-or-rejection/$ern/$arc")
  ...
  def put(userAnswers: UserAnswers)
    ...
    http
      .put(url"$baseUrl/user-answers/alert-or-rejection/${userAnswers.ern}/${userAnswers.arc}")
  ...
  def delete(ern: String, arc: String)
    ...
    http
      .delete(url"$baseUrl/user-answers/alert-or-rejection/$ern/$arc")
