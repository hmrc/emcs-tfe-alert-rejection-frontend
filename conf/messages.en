...
confirmation.alert.heading = Alert submitted
confirmation.alert.h2 = Alert information
confirmation.reject.heading = Rejection submitted
confirmation.reject.h2 = Rejection information
confirmation.arc.label = Administrative reference code (ARC)
confirmation.submissionType.label = Alert or rejection
confirmation.submissionType.alert.value = Alert
confirmation.submissionType.reject.value = Rejection
confirmation.alert.reasons.label = Reason(s) for alert
confirmation.reject.reasons.label = Reason(s) for rejection
...
confirmation.alert.p1 = The movement will be updated to show you have successfully submitted an alert. This may not happen straight away.
confirmation.reject.p1 = The movement will be updated to show you have successfully submitted a rejection. This may not happen straight away.
confirmation.heading1 = If you have alerted the consignor to an issue
confirmation.heading1.p1 = The movement can continue but you may wish to contact the consignor to discuss the issue. Depending on the issue and movement status, the consignor may choose to cancel or submit a change of destination.
confirmation.heading2 = If you have rejected the movement
