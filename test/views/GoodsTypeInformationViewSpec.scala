...
import fixtures.messages.GoodsTypeInformationMessages
...
class GoodsTypeInformationViewSpec extends ViewSpecBase with ViewBehaviours {

  object Selectors extends BaseSelectors

  lazy val form = app.injector.instanceOf[GiveInformationFormProvider].apply(true)
  lazy val view = app.injector.instanceOf[GoodsTypeInformationView]
