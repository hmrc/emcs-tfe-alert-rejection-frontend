...
class ConsigneeInformationViewSpec extends ViewSpecBase with ViewBehaviours {

  object Selectors extends BaseSelectors

  lazy val form = app.injector.instanceOf[ConsigneeInformationFormProvider].apply()
  lazy val view = app.injector.instanceOf[ConsigneeInformationView]
