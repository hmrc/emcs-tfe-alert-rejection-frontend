...
class GoodsQuantitiesInformationViewSpec extends ViewSpecBase with ViewBehaviours {

  object Selectors extends BaseSelectors

  lazy val form = app.injector.instanceOf[GiveInformationFormProvider].apply(isMandatory = false)
  lazy val view = app.injector.instanceOf[GoodsQuantitiesInformationView]
