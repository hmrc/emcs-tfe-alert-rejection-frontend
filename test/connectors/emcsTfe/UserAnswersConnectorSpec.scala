  ...
  ".get()" - {
    ...
    "should return a successful response" - {
      ...
      "when downstream call is successful and returns some JSON" in {
        ...
        MockHttpClient.get(url"${appConfig.emcsTfeBaseUrl}/user-answers/alert-or-rejection/$testErn/$testArc")
  ...
  ".put()" - {
    ...
    "should return a successful response" - {
      ...
      "when downstream call is successful and returns some JSON" in {
        ...
        MockHttpClient.put(
          url = url"${appConfig.emcsTfeBaseUrl}/user-answers/alert-or-rejection/$testErn/$testArc",
