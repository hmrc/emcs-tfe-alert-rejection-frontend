...
import viewmodels.checkAnswers.SelectReasonSummary

trait MockSelectReasonSummary extends MockFactory {

  lazy val mockSelectReasonSummary: SelectReasonSummary = mock[SelectReasonSummary]
